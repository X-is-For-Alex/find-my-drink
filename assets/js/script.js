...
// function fuzzySearch(searchInput) {
...
//       console.log(`v: ${searchInput.toLowerCase().value}`)
//     }).get()
//   console.log(results)
//   return results;
// }
...
//       $.getJSON(
//         'https://www.thecocktaildb.com/api/json/v1/1/filter.php?i=' + cocktailSearch, 
//           function (data) {
//               response(data);
//           });
//   };
...
//       $("#cocktailSearch").val(ui.item.value);
//       return false;
//   }
...
//       minLength: 4,
//       change: function() {
//           $("#cocktailSearch").val("").css("display", 2);
//       }
//   });
// });
